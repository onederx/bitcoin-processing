...
const (
	...
	// TODO: move this comment to wallet or remove it
	// CheckTxStatusEvent is a special event that is targeted inside processing
	// app itself, not to client - this event is for wallet updater and means
	// there are some updates with wallet-related txns that should be requested
	// from Bitcoin node. This event is not send neither through HTTP callback
	// nor through websocket. It can be generated by requesting HTTP API url
	// '/notify_wallet'
